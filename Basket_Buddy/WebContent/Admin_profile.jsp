...
<body>
    <%
        ...
        try {
            ...
            // Assuming you have admin ID stored in session
            int aid = GetSet3.getAdid(); // Verify this is the correct method
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <ul>
                ...
                <li class="active"><a href="Admin_profile.jsp" style="color: inherit; text-decoration: none; display: block;">Admin Profile</a></li>
        ...
        <div class="profile-container">
            ...
            <div class="profile-details">
                <div class="profile-field">
                    ...
                    <div class="value"><%= rs.getInt("id") %></div> 
                </div>
                ...
                <div class="profile-field">
                    ...
                    <div class="value"><%= rs.getString("username") %></div>
                </div>
            </div> 
    ...
    <%
                ...
                // Admin not found
                response.sendRedirect("error.jsp?message=Admin not found");
            }
