...
<body>
    <%
        ...
        try {
            ...
            if (city != null && !city.isEmpty()) {
                query = "SELECT * FROM offer WHERE status = 'approved' AND city LIKE ?";
                ps = con.prepareStatement(query);
                ps.setString(1, "%" + city + "%");
            } else {
                query = "SELECT * FROM offer WHERE status = 'approved'";
                ps = con.prepareStatement(query);
            }
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <h3>Navigation</h3>
            <ul>
                <li class="active" ><a href="View_user_dashboard.jsp" style="color: inherit; text-decoration: none; display: block;">Search Offers</a></li>
        ...
        <div class="offers-container">
            <div class="content-header">
                ...
                <div class="search-container">
                    <form method="GET" action="View_user_dashboard.jsp">
                        <input type="text" name="city" placeholder="Search by city..." value="<%= city != null ? city : "" %>">
                        <button type="submit" class="btn-primary">Search</button>
                        <% if(city != null && !city.isEmpty()) { %>
                            <a href="View_user_dashboard.jsp" class="btn-warning" style="text-decoration: none; display: inline-block; padding: 10px 20px;">Clear</a>
                        <% } %>
                    </form>
                </div>
            </div>
            ...
            <table class="offer-table">
                ...
                %>
                    <tr>
                        <td colspan="7" class="no-offers">No offers found<% if (city != null && !city.isEmpty()) { %> for <%= city %><% } %></td>
                    </tr>
                <%
                    }
                %>
