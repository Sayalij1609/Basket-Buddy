...
try {
    ...
    PreparedStatement pstmt = con.prepareStatement("DELETE FROM offer WHERE oid = ?");
    pstmt.setInt(1, id);
    int i = pstmt.executeUpdate();
    if (i > 0) {
        response.sendRedirect("Delete_offers.jsp");
    } else {
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <ul>
                ...
                <li class="active"><a href="Delete_offers.jsp" style="color: inherit; text-decoration: none; display: block;">Delete Offers</a></li>
            ...
            <table class="offer-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= rs.getInt(11) %></td>
                        <td>
                            <a href="Delete_offers.jsp?id=<%= rs.getInt(1) %>" class="delete-link">Delete</a>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
