...
<head>
    ...
    <title>Advertiser Profile - OfferMandi</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <%
        ...
        try {
            ...
            String query = "SELECT * FROM advertiser WHERE aid = ?";
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <ul>
                ...
                <li class="active"><a href="Advertiser_profile.jsp" style="color: inherit; text-decoration: none; display: block;">Advertiser Profile</a></li>
        ...
        <div class="profile-container">
            ...
            <div class="profile-details">
                <div class="profile-field">
                    ...
                    <div class="value"><%= rs.getInt("aid") %></div>
                </div>
                ...
                <div class="profile-field">
                    ...
                    <div class="value"><%= rs.getString("bname") %></div>
                </div>
                ...
                <div class="profile-field">
                    <label>City</label>
                    <div class="value"><%= rs.getString("city") %></div>
                </div>
